...
\begin{tikzpicture}[>=stealth,line join=round,line cap=round,scale=1.05,font=\large]
  \node[font=\bfseries\Large, text=blue!80!black] at (0, 3.6) {ĐỒ THỊ HÀM SỐ (HÌNH 1.5 SGK)};
  ...
  % Cac diem toa do dau bai cho san
